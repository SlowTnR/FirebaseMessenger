...
extension DatabaseManager {
    /// Creattes a nwe conversatiton witth target user email and first message sent
    ...
    private func finishCreatingConversation(name: String, conversationID: String, firstMessage: Message, completion: @escaping (Bool) -> Void){
        ...
        print("Adding conversation with ID: \(conversationID)")
    ...
    /// Fetches and returns all conversations for tthe user wuth passed in email
    public func getAllConversatitons(for email: String, completion: @escaping (Result<[Conversation], Error>) -> Void){
    ...
    public func deleteConversation(conversationId: String, completion: @escaping (Bool) -> Void){
        ...
        print("Deleteng conversation with id: \(conversationId)")
        
        // get all conversations for current user
        // delete conversation in collection with target id
        // resete those conversations for user and databes
